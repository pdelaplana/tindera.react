// ShopImageSection - Hero image display with "Update Photo" overlay button
...
interface ShopImageSectionProps {
...
const ShopImageSection: React.FC<ShopImageSectionProps> = ({
  imageUrl,
  shopId,
  onImageUploaded,
  onUploadError,
  ...
  const handleFileChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      validateFile(file);
      const publicUrl = await uploadShopLogo(file, shopId);
  ...
  return (
    <Container>
      ...
      {imageUrl ? (
        <Image src={imageUrl} alt="Shop logo" />
      ) : (
        <Placeholder>No shop image</Placeholder>
      )}
      ...
      <UpdateButton
        ...
        aria-label={isUploading ? 'Uploading shop logo' : 'Update shop photo'}
      >
        {isUploading ? (
