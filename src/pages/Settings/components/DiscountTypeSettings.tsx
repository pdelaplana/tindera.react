...
import { addOutline, checkmarkOutline, closeOutline, createOutline, trashOutline } from 'ionicons/icons';
								...
								{editingId === discountType.id ? (
									<>
										<IonInput
											...
											style={{ flex: 1 }}
										/>
										<IonButton fill="clear" color="success" onClick={() => handleSaveEdit(discountType.id)}>
