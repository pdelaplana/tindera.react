  ...
  public: {
    Tables: {
      discount_types: {
        ...
        Relationships: [
          {
            foreignKeyName: "discount_types_shop_id_fkey"
            columns: ["shop_id"]
            isOneToOne: false
      ...
      order_taxes: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "order_taxes_shop_tax_id_fkey"
            columns: ["shop_tax_id"]
            isOneToOne: false
            referencedRelation: "shop_taxes"
            referencedColumns: ["id"]
          },
        ]
      }
      orders: {
        ...
        Relationships: [
          {
            foreignKeyName: "orders_discount_type_id_fkey"
          ...
          {
            foreignKeyName: "orders_refund_reason_id_fkey"
            columns: ["refund_reason_id"]
            isOneToOne: false
            referencedRelation: "void_refund_reasons"
            referencedColumns: ["id"]
          },
          {
          ...
          {
            foreignKeyName: "orders_void_reason_id_fkey"
      ...
      shop_taxes: {
        ...
        Relationships: [
          {
            foreignKeyName: "shop_taxes_shop_id_fkey"
            columns: ["shop_id"]
            isOneToOne: false
            referencedRelation: "shops"
            referencedColumns: ["id"]
      ...
      void_refund_reasons: {
        ...
        Relationships: [
          {
            foreignKeyName: "void_refund_reasons_shop_id_fkey"
            columns: ["shop_id"]
            isOneToOne: false
            referencedRelation: "shops"
            referencedColumns: ["id"]
